...
/**
 * VtpCategory form base class.
 *
 * @method VtpCategory getObject() Returns the current form's model object
 *
 * @package    Web_Portals
 * @subpackage form
 * @author     ngoctv1
 ...
 */
abstract class BaseVtpCategoryForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'parent_id'   => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('VtpParentCategory'), 'required' => false)),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'VtpCategory', 'column' => array('slug')))
    );

    $this->widgetSchema->setNameFormat('vtp_category[%s]');
