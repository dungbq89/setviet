...
/**
 * AdCategoryPermission filter form base class.
 *
 * @package    Web_Portals
 * @subpackage filter
 * @author     ngoctv1
 ...
 */
abstract class BaseAdCategoryPermissionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ad_category_permission_filters[%s]');
