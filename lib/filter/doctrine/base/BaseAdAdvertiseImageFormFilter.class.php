...
/**
 * AdAdvertiseImage filter form base class.
 *
 * @package    Web_Portals
 * @subpackage filter
 * @author     ngoctv1
 ...
 */
abstract class BaseAdAdvertiseImageFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'advertise_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('AdAdvertiseImage'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('ad_advertise_image_filters[%s]');
