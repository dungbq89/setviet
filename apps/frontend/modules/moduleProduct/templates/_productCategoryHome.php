...
if (isset($productCategory) && count($productCategory)) {
    foreach ($productCategory as $key => $value) {
        $categoryChild = $value->getCategoryByParent(5);
        if (count($categoryChild) >= 0) {
            ...
            <div class="dientuamthanh all">
                    ...
                    <div class="views_sp">
                        <ul class="list-item">
                            ...
                            foreach ($productHome as $product) {
                                ...
                                <li>
                                    <div class="bos_sp2">
                                        <a href="<?php echo url_for2('product_detail', array('slug' => $product['slug'])) ?>"
                                           title="<?php echo htmlspecialchars($product['product_name']); ?>">
                                            <img
                                                src="<?php echo VtHelper::getThumbUrl($path, 180, 140, 'product_180_140') ?>"
                                    ...
                                    <span class="product-name"><a
                                            href="<?php echo url_for2('product_detail', array('slug' => $product['slug'])) ?>"
                ...
                <div class="quangcao_2 all">
                    ...
                    <?php
                    if ($value->show_banner && $value->image_path) {
                        $pathCate = '/uploads/' . sfConfig::get('app_category_images') . $value->image_path;
                        ?>
                        <a href="<?php $value->link?$value->link:'' ?>">
                            <img src="<?php echo VtHelper::getThumbUrl($pathCate, 1200, 100, '') ?>">
                        </a>
                    <?php
                    }
                    ?>
